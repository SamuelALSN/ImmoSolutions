...
//             if (this._map) {
//                 var _ = 0, l = (new Date).getTime(), d = L.bind(function () {
...
//                 return this
//             }
//             if (this._unspiderfy) for (this._unspiderfy(), e = 0, i = t.length; i > e; e++) n = t[e], this._unspiderfyLayer(n);
...
//             var a, h = t.__parent, u = h._markers;
...
//             var t, e, i, n, s = this._markers, r = this._childClusters, o = 0, a = 0, h = this._childCount;
//             if (0 !== h) {
...
//             var e, i, n, s, r, o, a, h, u = this._getCoord(t.x), _ = this._getCoord(t.y), l = this._objectPoint,
//                 d = this._sqCellSize, c = null;
//             for (e = _ - 1; _ + 1 >= e; e++) if (s = this._grid[e]) for (i = u - 1; u + 1 >= i; i++) if (r = s[i]) for (n = 0, o = r.length; o > n; n++) a = r[n], h = this._sqDist(l[L.Util.stamp(a)], t), d > h && (d = h, c = a);
//             return c
...
//                 var e, i = !1, n = !1, s = !1, r = !1, o = null, a = null, h = null, u = null, _ = null, l = null;
...
//     }), L.MarkerCluster.include({
//         _animationSpiderfy: function (t, e) {
//             var n, s, r, o, a, h, u = this, _ = this._group, l = _._map, d = _._featureGroup, c = this._latlng,
//                 p = l.latLngToLayerPoint(c), f = L.Path.SVG,
...
//             for (_._forceLayout(), _._animationStart(), n = t.length - 1; n >= 0; n--) h = l.layerPointToLatLng(e[n]), s = t[n], s._preSpiderfyLatlng = s._latlng, s.setLatLng(h), s.clusterShow && s.clusterShow(), f && (r = s._spiderLeg, o = r._path, o.style.strokeDashoffset = 0, r.setStyle({opacity: g}));
...
//             var e, i, n, s, r, o, a = this, h = this._group, u = h._map, _ = h._featureGroup,
