!function (t, e) {
    ...
    return function (t) {
        ...
        var s = /[-+]?\d+(?:.\d+)?(?:s|ms)/i, a = /\s*,\s*/, c = /(?:\s*,)?\s*([^(,]+(?:\([^)]+\))?)/g;
        i.defaultOptions = {
            duration: "400ms",
            delay: "0s",
            timingFunction: "ease",
            ...
            var s = void 0, a = void 0, c = void 0, u = [];
            if (e.hasOwnProperty("properties") && (n = e, e = e.properties), o.isString(e)) u.push(new r(e)); else if (o.isArray(e)) if (o.isString(e[0]) && e[0].indexOf(" ") === -1) u.push(new r(e)); else for (a = 0; a < e.length; a++) c = e[a], !o.isArray(c) && c instanceof r || (c = new r(c)), u.push(c); else if ("property" in e) c = new r(e), u.push(c); else for (c in e) e.hasOwnProperty(c) && (o.isArray(e[c]) ? (c = [c].concat(e[c]), c = new r(c)) : (c = o.defaults({property: c}, e[c]), c = new r(c)), u.push(c));
            ...
            var e = void 0, n = void 0, r = void 0, i = void 0, s = void 0, u = [], l = [], p = [], h = [], f = void 0,
                d = void 0, _ = void 0, v = void 0, y = void 0;
            if (n = t.style[o.transitionProperty]) {
                if (r = t.style[o.transitionDuration], i = t.style[o.transitionDelay], s = t.style[o.transitionTimingFunction], u = n.split(a), l = r ? r.split(a) : ["0s"], p = i ? i.split(a) : ["0s"], s) for (h = []; f = null !== c.exec(s);) h.push(f[1]); else h = ["ease"];
                for (d = u.length, _ = l.length, v = p.length, y = h.length, e = 0; e < d; e++) _ <= e && l.push(l[e % _]), v <= e && p.push(p[e % v]), y <= e && h.push(h[e % y])
            }
            return {cssProperties: u, durations: l, delays: p, timingFunctions: h}
            ...
            constructor: i, beginTransition: function (t) {
                ...
                var e = void 0;
                for (e = 0; e < this.properties.length; e++) if (this.properties[e].cssProperty === t) return this.properties[e];
                ...
                var e = void 0, n = void 0, r = void 0, o = void 0, s = void 0, a = void 0, c = void 0, u = !1;
                ...
                var i = void 0, o = void 0, s = void 0, a = void 0, c = void 0;
                ...
                var r = void 0, i = void 0, s = void 0, a = void 0;
        ...
        }, t.exports = {TransitionProperty: r, property: i.property, transition: i.begin, begin: i.begin}
    }, function (t, e) {
        "use strict";
        ...
        function r() {
            var t = void 0, e = u.slice(), n = void 0, r = void 0;
        ...
        var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
            ...
            }, o = /[A-Z]/g, s = /^[A-Z]/, a = /-([a-z])/g, c = /^ms-/, u = [], l = {}, p = {
                ...
                var t = document.createElement("div"), e = ["Webkit", "Moz", "O", "ms", "Khtml"], n = /^[a-z]/,
                    r = e.length;
                return function (i) {
                    ...
                    }), o = 0; o < r; o++) if (s = e[o] + a, "undefined" != typeof t.style[s]) return l[i] = s, s;
                    return null
                }
            }(), f = null !== h("transition"), d = h("transitionProperty"), _ = h("transitionDuration"),
            v = h("transitionDelay"), y = h("transitionTimingFunction"), m = p[h("transition")];
        t.exports = {
            ...
            executeInNextEventLoop: function (t, e) {
                0 === u.length && window.setTimeout(r, 0), u.push({func: t, context: e})
            },
            extend: function (t) {
            ...
            !function (e) {
                ...
                return function t(e, n, r) {
                    ...
                    1: [function (t, e, n) {
                        ...
                        var u = t("./schedule"), l = t("./queue"), p = t("./util");
                        ...
                        e.exports = function (t, e, n, r) {
                            ...
                            t.prototype.bind = function (o) {
                                ...
                                if (l._setBoundTo(u), u instanceof t) {
                                    var h = {promiseRejectionQueued: !1, promise: l, target: p, bindingPromise: u};
                        ...
                        n.exports = function (n, r) {
                            ...
                            function v(t, e, n, r, i) {
                                if (void 0 === t && null !== e && K) {
                                    ...
                                    if (e._trace) {
                                        ...
                                        if (c.length > 0) for (var h = c[0], u = 0; u < a.length; ++u) if (a[u] === h) {
                                            u > 0 && (s = "\n" + a[u - 1]);
                                            break
                                        }
                                    }
                            ...
                            var A, V, B, I = n._getDomain, N = n._async, D = t("./errors").Warning, L = t("./util"),
                                H = L.canAttachTrace, U = /[\\\/]bluebird[\\\/]js[\\\/](release|debug|instrumented)/,
                                M = /\((?:timers\.js):\d+:\d+\)/, q = /[\/<\(](.+?):(\d+):(\d+)\)?\s*$/, $ = null,
                                Q = null, W = !1, z = !(0 == L.env("BLUEBIRD_DEBUG")),
                            ...
                            var J = function () {
                                try {
                                    ...
                                    return t.initCustomEvent("testingtheevent", !1, !0, {}), L.global.dispatchEvent(t), function (t, e) {
                            ...
                            var ot = function () {
                                ...
                                var r = new Error;
                                if ("string" == typeof r.stack && r.stack.split("\n")[0].indexOf("stackDetection@") >= 0) return $ = /@/, Q = e, W = !0, function (t) {
                        ...
                        var o, s, a = t("./es5"), c = a.freeze, u = t("./util"), l = u.inherits,
                            p = u.notEnumerableProp, h = r("Warning", "warning"),
                            f = r("CancellationError", "cancellation error"), d = r("TimeoutError", "timeout error"),
                        ...
                        e.exports = function (e, n) {
                            ...
                            var u = t("./util"), l = e.CancellationError, p = u.errorObj;
                        ...
                        e.exports = function (e, n, r, i, o, s) {
                            ...
                            var u = t("./errors"), l = u.TypeError, p = t("./util"), h = p.errorObj, f = p.tryCatch,
                                d = [];
                        ...
                        e.exports = function (e, n, r, i, o, s) {
                            ...
                            var u = e._getDomain, l = t("./util"), p = l.tryCatch, h = l.errorObj, f = e._async;
                            l.inherits(a, n), a.prototype._asyncInit = function () {
                                ...
                                if (n < 0) {
                                    ...
                                    null !== a && (a[n] = t);
                                    var u = this._promise, l = this._callback, f = u._boundValue();
                                    u._pushContext();
                                    var d = p(l).call(f, t, n, o), _ = u._popContext();
                        ...
                        var s = t("./util"), a = s.maybeWrapAsError, c = t("./errors"), u = c.OperationalError,
                            l = t("./es5"), p = /^(?:name|message|stack|cause)$/;
                        e.exports = o
                        ...
                        n.exports = function () {
                            ...
                            var w = function () {
                                }, C = {}, T = {}, E = t("./thenables")(o, w), F = t("./promise_array")(o, w, E, h, r),
                                P = t("./context")(o), j = P.create, k = t("./debuggability")(o, P),
                                x = (k.CapturedTrace, t("./finally")(o, E)), S = t("./catch_filter")(T),
                                O = t("./nodeback"), R = d.errorObj, A = d.tryCatch;
                            return o.prototype.toString = function () {
                                ...
                                var n = arguments.length > 1 && !!Object(arguments[1]).multiArgs, r = A(t)(O(e, n));
                                ...
                                var s = void 0 !== i, a = s ? i : new o(w), c = this._target(), l = c._bitField;
                            ...
                            }), c(void 0), c(!1), c(new o(w)), k.setBounds(v.firstLineError, d.lastLineError), o
                        }
                    }, {
                        "./any.js": 1,
                        "./async": 2,
                        ...
                        e.exports = function (e, n) {
                            ...
                            function c(t, r, i, o, s, a) {
                                function c() {
                                    ...
                                    var s = "string" == typeof l && this !== u ? this[l] : t, c = d(o, a);
                                    try {
                            ...
                            function u(t, e, n, r, i) {
                                for (var o = new RegExp(E(e) + "$"), s = a(t, e, o, n), c = 0, u = s.length; c < u; c += 2) {
                                    var l = s[c], p = s[c + 1], d = l + e;
                                    if (r === F) t[d] = F(l, h, l, p, e, i); else {
                                        var _ = r(p, function () {
                            ...
                            var p, h = {}, f = t("./util"), d = t("./nodeback"), _ = f.withAppended,
                                v = f.maybeWrapAsError, y = f.canEvaluate, m = t("./errors").TypeError, g = "Async",
                                b = {__isPromisified__: !0},
                                w = ["arity", "length", "name", "arguments", "caller", "callee", "prototype", "__isPromisified__"],
                                C = new RegExp("^(?:" + w.join("|") + ")$"), T = function (t) {
                            ...
                            e.promisify = function (t, e) {
                                ...
                                if (i(t)) return t;
                                e = Object(e);
                                var n = void 0 === e.context ? h : e.context, o = !!e.multiArgs, s = l(t, n, o);
                        ...
                        e.exports = function (e, n, r, i, o, s) {
                            ...
                            var h = e._getDomain, f = t("./util"), d = f.tryCatch;
                        ...
                        if (a.isNode && "undefined" == typeof MutationObserver) {
                            var l = n.setImmediate, p = e.nextTick;
                        ...
                        e.exports = function (e, n, r) {
                            ...
                            var s = t("./util"), a = t("./errors").RangeError, c = t("./errors").AggregateError,
                                u = s.isArray, l = {};
                        ...
                        e.exports = function (e, n, r, i, o, s) {
                            ...
                            var d = t("./util"), _ = t("./errors").TypeError, v = t("./util").inherits, y = d.errorObj,
                                m = d.tryCatch, g = {};
                            l.prototype.data = function () {
                                ...
                                for (var c = new f(t), p = 0; p < t; ++p) {
                                    ...
                                    if (l.isDisposer(_)) {
                                        ...
                                        var g = r(_);
                                        g instanceof e && (_ = g._then(h, null, null, {resources: c, index: p}, void 0))
                                    }
                                    c[p] = _
                                }
                        ...
                        var k = t("./es5"), x = "undefined" == typeof navigator, S = {e: {}}, O,
                            ...
                            }(), B = /this\s*\.\s*\S+\s*=/, I = /^[a-z$_][a-z$_0-9]*$/i, N = function () {
                        ...
                        var H = "undefined" != typeof e && "[object process]" === T(e).toLowerCase(),
                            U = "undefined" != typeof e && "undefined" != typeof e.env, M = {
                                isClass: d,
                                isIdentifier: v,
                                inheritedDataKeys: V,
        ...
        (function (t, e) {
            !function (t, n) {
                ...
                if (!t.setImmediate) {
                    var f, d = 1, _ = {}, v = !1, y = t.document, m = Object.getPrototypeOf && Object.getPrototypeOf(t);
