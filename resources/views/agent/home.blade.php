                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card text-white bg-primary">
                                <div class="card-body pb-0">
                                    ...
                                    <div class="text-value">{{count($agents_properties)}}</div>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card text-white bg-info">
                                <div class="card-body pb-0">
                                    ...
                                    <div class="text-value">{{count($valid_properties)}}</div>
                                    <div>@lang("Biens Validés")</div>
                                </div>
                                <div class="chart-wrapper mt-3 mx-3" style="height:70px;">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card text-white bg-warning">
                                <div class="card-body pb-0">
                                    ...
                                    <div class="text-value">{{count($reserv_properties)}}</div>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card text-white bg-danger">
                                <div class="card-body pb-0">
                                    ...
                                    <div class="text-value">{{count($ask_properties)}}</div>
                                    <div>@lang("Demande de réservations ")</div>
                                </div>
                                <div class="chart-wrapper mt-3 mx-3" style="height:70px;">
...
@section('script')
    ...
    <script>
        ...
        var res_properties = <?php print_r(json_encode($reserv_properties)) ?>;
        ...
        var Ask_resLabels= new Array();
          ...
          res_properties.forEach(function(data){
