                            ...
                            <div class="project-single mb-0 bb-0">
                                <div class="project-inner project-head">
                                    <div class="project-bottom">
                                        <h4><a href="">@lang("Details ")</a><span class="category">{{$property->propertytype['name']}}</span></h4>
                                    </div>
                                    <div class="button-effect">
                                        <a href="" class="btn"><i class="fa fa-link"></i></a>
                                        <a href="" class="btn popup-video popup-youtube"><i class="fas fa-video"></i></a>
                                        <a class="img-poppu btn" href="" data-rel="lightcase:myCollection:slideshow"><i class="fa fa-photo"></i></a>
                                    </div>
                                    <div class="homes">
                                        <!-- homes img -->
                            ...
                            <div class="price-properties">
                                <h3 class="title mt-3">
                                    @foreach($property->typetransactions as $typetrans)
                                        <a href=""> {{$typetrans->pivot->ammount}}</a>
                                    @endforeach
                                </h3>
                                <div class="compare">
