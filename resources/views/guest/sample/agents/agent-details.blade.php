...
<body class="inner-pages">
	...
	<div class="header">
				...
				<div class="top-social hidden-sm-down">
					...
					<div class="social-icons-header">
						<div class="social-icons">
							<a href="agent-details.html#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
							<a href="agent-details.html#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
							<a href="agent-details.html#"><i class="fa fa-google-plus" aria-hidden="true"></i></a>
						</div>
					</div>
					<div class="dropdown">
		...
		<div class="header-bottom heading sticky-header" id="heading">
			<div class="container">
				...
				<form action="agent-details.html#" id="bloq-search" class="collapse">
				...
				<nav id="main-menu" class="collapse">
					<ul>
						...
						<li class="hidden-lg-up">
							<div class="po">
								<a data-toggle="collapse" href="agent-details.html#home" aria-expanded="false">Home</a>
							</div>
						...
						<li class="dropdown hidden-md-down">
							<a class="active dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="agent-details.html#">Home</a>
						...
						<li class="hidden-lg-up">
							<div class="po">
								<a data-toggle="collapse" href="agent-details.html#listing" aria-expanded="false">Properties</a>
							</div>
						...
						<!-- END COLLAPSE MOBILE MENU -->
						<li class="dropdown hidden-md-down">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="agent-details.html#">Properties</a>
							<div class="dropdown-menu">
								<a class="dropdown-item" href="properties-full-list.html">Full List</a>
								<a class="dropdown-item" href="properties-list-right-sidebar.html">List Right Sidebar </a>
								<a class="dropdown-item" href="properties-full-grid.html">Full Grid</a>
						...
						<li class="hidden-lg-up">
							<div class="po">
								<a data-toggle="collapse" href="agent-details.html#services" aria-expanded="false">Agents</a>
							</div>
						...
						<!-- END COLLAPSE MOBILE MENU -->
						<li class="dropdown hidden-md-down">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="agent-details.html#">Agents</a>
							<div class="dropdown-menu">
								<a class="dropdown-item" href="agents-listing-grid.html">Agents Listing Grid</a>
								<a class="dropdown-item" href="agents-listing-row.html">Agents Listing Row</a>
								<a class="dropdown-item" href="agent-details.html">Agent Details</a>
						...
						<li class="hidden-lg-up">
							<div class="po">
								<a data-toggle="collapse" href="agent-details.html#about" aria-expanded="false">Pages</a>
							</div>
						...
						<!-- END COLLAPSE MOBILE MENU -->
						<li class="dropdown hidden-md-down">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="agent-details.html#">Pages</a>
							<div class="dropdown-menu">
								<a class="dropdown-item" href="about.html">About Us</a>
								<a class="dropdown-item" href="faq.html">Faq</a>
								<a class="dropdown-item" href="pricing-table.html">Pricing</a>
						...
						<li class="hidden-lg-up">
							<div class="po">
								<a data-toggle="collapse" href="agent-details.html#blog" aria-expanded="false">Blog</a>
							</div>
						...
						<!-- END COLLAPSE MOBILE MENU -->
						<li class="dropdown hidden-md-down">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="agent-details.html#">Blog</a>
							<div class="dropdown-menu">
								<a class="dropdown-item" href="blog.html">Blog Default</a>
								<a class="dropdown-item" href="blog-rightsidebar.html">Blog Right Sidebar</a>
								<a class="dropdown-item" href="blog-details.html">Blog Details</a>
					...
					<div class="agent agent-row shadow-hover">
						...
						<div class="agent-content">
							...
							<div class="agent-footer center">
								<ul class="netsocials">
									<li><a href="agent-details.html#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
									<li><a href="agent-details.html#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
									<li><a href="agent-details.html#"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
									<li><a href="agent-details.html#"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
								</ul>
							</div>
						</div>
						<div class="clear"></div>
								...
								<div class="project-single">
									...
									<div class="homes-content">
										...
										<div class="price-properties">
											...
											<div class="compare">
												<a href="agent-details.html#" title="Compare">
													<i class="fas fa-exchange-alt"></i>
												</a>
												<a href="agent-details.html#" title="Share">
													<i class="fas fa-share-alt"></i>
												</a>
												<a href="agent-details.html#" title="Favorites">
			...
			<nav aria-label="...">
				<ul class="pagination mt-3">
					<li class="page-item disabled">
						<a class="page-link" href="agent-details.html#" tabindex="-1">Previous</a>
					</li>
					<li class="page-item active">
						<a class="page-link" href="agent-details.html#">1 <span class="sr-only">(current)</span></a>
					</li>
					<li class="page-item"><a class="page-link" href="agent-details.html#">2</a></li>
					<li class="page-item"><a class="page-link" href="agent-details.html#">3</a></li>
					<li class="page-item"><a class="page-link" href="agent-details.html#">3</a></li>
					<li class="page-item"><a class="page-link" href="agent-details.html#">5</a></li>
					<li class="page-item">
						<a class="page-link" href="agent-details.html#">Next</a>
					</li>
				</ul>
			</nav>
		</div>
							...
							<div class="twitter-widget contuct">
								<div class="twitter-area">
									<div class="single-item">
										...
										<div class="text">
											<h5><a href="agent-details.html#">@findhouses</a> all share them with me baby said inspet.</h5>
	...
	<a data-scroll href="agent-details.html#heading" class="go-up"><i class="fa fa-angle-double-up" aria-hidden="true"></i></a>
	<!-- END FOOTER -->
	<!--Style Switcher===========================================-->
	<div class="color-switcher" id="choose_color"> <a href="agent-details.html#." class="picker_close"><i class="fa fa-cog fa-spin fa-2x" ></i></a>
		<div class="theme-colours">
			<p class="font-italic">Choose Colour style</p>
			<ul>
				<li>
					<a href="agent-details.html#." class="blue" id="blue"></a>
				</li>
				<li>
					<a href="agent-details.html#." class="pink" id="pink"></a>
				</li>
				<li>
					<a href="agent-details.html#." class="orange" id="orange"></a>
				</li>
				<li>
					<a href="agent-details.html#." class="purple" id="purple"></a>
				</li>
				<li>
					<a href="agent-details.html#." class="green" id="green"></a>
				</li>
				<li>
					<a href="agent-details.html#." class="red" id="red"></a>
				</li>
				<li>
					<a href="agent-details.html#." class="cyan" id="cyan"></a>
				</li>
				<li>
					<a href="agent-details.html#." class="sky-blue" id="sky-blue"></a>
				</li>
				<li>
					<a href="agent-details.html#." class="gray" id="gray"></a>
				</li>
				<li>
					<a href="agent-details.html#." class="brown" id="brown"></a>
				</li>
			</ul>
		</div>
	</div>
