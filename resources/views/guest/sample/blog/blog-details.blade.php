...
<body class="inner-pages">
	...
	<div class="header">
				...
				<div class="top-social hidden-sm-down">
					...
					<div class="social-icons-header">
						<div class="social-icons">
							<a href="blog-details.html#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
							<a href="blog-details.html#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
							<a href="blog-details.html#"><i class="fa fa-google-plus" aria-hidden="true"></i></a>
						</div>
					</div>
					<div class="dropdown">
		...
		<div class="header-bottom heading sticky-header" id="heading">
			<div class="container">
				...
				<form action="blog-details.html#" id="bloq-search" class="collapse">
				...
				<nav id="main-menu" class="collapse">
					<ul>
						...
						<li class="hidden-lg-up">
							<div class="po">
								<a data-toggle="collapse" href="blog-details.html#home" aria-expanded="false">Home</a>
							</div>
						...
						<li class="dropdown hidden-md-down">
							<a class="active dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="blog-details.html#">Home</a>
						...
						<li class="hidden-lg-up">
							<div class="po">
								<a data-toggle="collapse" href="blog-details.html#listing" aria-expanded="false">Properties</a>
							</div>
						...
						<!-- END COLLAPSE MOBILE MENU -->
						<li class="dropdown hidden-md-down">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="blog-details.html#">Properties</a>
							<div class="dropdown-menu">
								<a class="dropdown-item" href="properties-full-list.html">Full List</a>
								<a class="dropdown-item" href="properties-list-right-sidebar.html">List Right Sidebar </a>
								<a class="dropdown-item" href="properties-full-grid.html">Full Grid</a>
						...
						<li class="hidden-lg-up">
							<div class="po">
								<a data-toggle="collapse" href="blog-details.html#services" aria-expanded="false">Agents</a>
							</div>
						...
						<!-- END COLLAPSE MOBILE MENU -->
						<li class="dropdown hidden-md-down">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="blog-details.html#">Agents</a>
							<div class="dropdown-menu">
								<a class="dropdown-item" href="agents-listing-grid.html">Agents Listing Grid</a>
								<a class="dropdown-item" href="agents-listing-row.html">Agents Listing Row</a>
								<a class="dropdown-item" href="agent-details.html">Agent Details</a>
						...
						<li class="hidden-lg-up">
							<div class="po">
								<a data-toggle="collapse" href="blog-details.html#about" aria-expanded="false">Pages</a>
							</div>
						...
						<!-- END COLLAPSE MOBILE MENU -->
						<li class="dropdown hidden-md-down">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="blog-details.html#">Pages</a>
							<div class="dropdown-menu">
								<a class="dropdown-item" href="about.html">About Us</a>
								<a class="dropdown-item" href="faq.html">Faq</a>
								<a class="dropdown-item" href="pricing-table.html">Pricing</a>
						...
						<li class="hidden-lg-up">
							<div class="po">
								<a data-toggle="collapse" href="blog-details.html#blog" aria-expanded="false">Blog</a>
							</div>
						...
						<!-- END COLLAPSE MOBILE MENU -->
						<li class="dropdown hidden-md-down">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="blog-details.html#">Blog</a>
							<div class="dropdown-menu">
								<a class="dropdown-item" href="blog.html">Blog Default</a>
								<a class="dropdown-item" href="blog-rightsidebar.html">Blog Right Sidebar</a>
								<a class="dropdown-item" href="blog-details.html">Blog Details</a>
							...
							<div class="single-blog-post">
								<div class="blog-list img-box">
									...
									<div class="social">
										...
										<a href="blog-details.html#"><i class="fa fa-user-o"></i><span>Admin</span></a>
										<a href="blog-details.html#"><i class="fa fa-eye"></i><span>9243</span></a>
										<a href="blog-details.html#"><i class="fa fa-comments"></i><span>69</span></a>
									</div>
									<div class="overlay">
										<div class="box">
											<div class="content">
								...
								<div class="blog-info">
									...
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequuntur nostrum perspiciatis, error omnis tempore commodi eum vel nesciunt, ut vero, autem culpa! Consectetur accusamus, cumque molestias reiciendis incidunt, accusantium modi.</p>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequuntur nostrum perspiciatis, error omnis tempore commodi eum vel nesciunt, ut vero, autem culpa! Consectetur accusamus, cumque molestias reiciendis incidunt, accusantium modi.</p>
								</div>
							</div>
						</div>
					...
					<section class="comments">
						...
						<div class="row mb-4">
							<ul class="col-12 commented">
								<li class="comm-inf">
									<div class="col-md-2">
										<img src="images/testimonials/comment-user.jpg" class="img-fluid" alt="">
									</div>
				...
				<aside class="col-lg-3 col-md-12">
					<div class="widget">
						...
						<div class="recent-post py-5">
							...
							<ul>
								<li><a href="blog-details.html#"><i class="fa fa-caret-right" aria-hidden="true"></i>House</a></li>
								<li><a href="blog-details.html#"><i class="fa fa-caret-right" aria-hidden="true"></i>Garages</a></li>
								<li><a href="blog-details.html#"><i class="fa fa-caret-right" aria-hidden="true"></i>Real Estate</a></li>
								<li><a href="blog-details.html#"><i class="fa fa-caret-right" aria-hidden="true"></i>Real Home</a></li>
								<li><a href="blog-details.html#"><i class="fa fa-caret-right" aria-hidden="true"></i>Bath</a></li>
								<li><a href="blog-details.html#"><i class="fa fa-caret-right" aria-hidden="true"></i>Beds</a></li>
							</ul>
						</div>
						<div class="recent-post">
							<h5 class="font-weight-bold mb-4">Popolar Tags</h5>
							<div class="tags">
								<span><a href="blog-details.html#" class="btn btn-outline-primary">Houses</a></span>
								<span><a href="blog-details.html#" class="btn btn-outline-primary">Real Home</a></span>
							</div>
							<div class="tags">
								<span><a href="blog-details.html#" class="btn btn-outline-primary">Baths</a></span>
								<span><a href="blog-details.html#" class="btn btn-outline-primary">Beds</a></span>
							</div>
							<div class="tags">
								<span><a href="blog-details.html#" class="btn btn-outline-primary">Garages</a></span>
								<span><a href="blog-details.html#" class="btn btn-outline-primary">Family</a></span>
							</div>
							<div class="tags">
								<span><a href="blog-details.html#" class="btn btn-outline-primary">Real Estates</a></span>
								<span><a href="blog-details.html#" class="btn btn-outline-primary">Properties</a></span>
							</div>
							<div class="tags">
								<span><a href="blog-details.html#" class="btn btn-outline-primary">Location</a></span>
								<span><a href="blog-details.html#" class="btn btn-outline-primary">Price</a></span>
							</div>
						</div>
			...
			<div class="container">
				<div class="row">
							...
							<div class="twitter-widget contuct">
								<div class="twitter-area">
									<div class="single-item">
										...
										<div class="text">
											<h5><a href="blog-details.html#">@findhouses</a> all share them with me baby said inspet.</h5>
					...
					<div class="col-lg-3 col-md-6">
						...
						<ul class="netsocials">
							<li><a href="blog-details.html#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
							<li><a href="blog-details.html#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
							<li><a href="blog-details.html#"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
							<li><a href="blog-details.html#"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
						</ul>
					</div>
				</div>
			</div>
	...
	<a data-scroll href="blog-details.html#heading" class="go-up"><i class="fa fa-angle-double-up" aria-hidden="true"></i></a>
	<!-- END FOOTER -->
	<!--Style Switcher===========================================-->
	<div class="color-switcher" id="choose_color"> <a href="blog-details.html#." class="picker_close"><i class="fa fa-cog fa-spin fa-2x" ></i></a>
		<div class="theme-colours">
			<p class="font-italic">Choose Colour style</p>
			<ul>
				<li>
					<a href="blog-details.html#." class="blue" id="blue"></a>
				</li>
				<li>
					<a href="blog-details.html#." class="pink" id="pink"></a>
				</li>
				<li>
					<a href="blog-details.html#." class="orange" id="orange"></a>
				</li>
				<li>
					<a href="blog-details.html#." class="purple" id="purple"></a>
				</li>
				<li>
					<a href="blog-details.html#." class="green" id="green"></a>
				</li>
				<li>
					<a href="blog-details.html#." class="red" id="red"></a>
				</li>
				<li>
					<a href="blog-details.html#." class="cyan" id="cyan"></a>
				</li>
				<li>
					<a href="blog-details.html#." class="sky-blue" id="sky-blue"></a>
				</li>
				<li>
					<a href="blog-details.html#." class="gray" id="gray"></a>
				</li>
				<li>
					<a href="blog-details.html#." class="brown" id="brown"></a>
				</li>
			</ul>
		</div>
	</div>
