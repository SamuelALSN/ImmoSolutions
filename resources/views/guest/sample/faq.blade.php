...
<body class="inner-pages">
	...
	<div class="header">
				...
				<div class="top-social hidden-sm-down">
					...
					<div class="social-icons-header">
						<div class="social-icons">
							<a href="faq.html#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
							<a href="faq.html#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
							<a href="faq.html#"><i class="fa fa-google-plus" aria-hidden="true"></i></a>
						</div>
					</div>
					<div class="dropdown">
		...
		<div class="header-bottom heading sticky-header" id="heading">
			<div class="container">
				...
				<form action="faq.html#" id="bloq-search" class="collapse">
				...
				<nav id="main-menu" class="collapse">
					<ul>
						...
						<li class="hidden-lg-up">
							<div class="po">
								<a data-toggle="collapse" href="faq.html#home" aria-expanded="false">Home</a>
							</div>
						...
						<li class="dropdown hidden-md-down">
							<a class="active dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="faq.html#">Home</a>
						...
						<li class="hidden-lg-up">
							<div class="po">
								<a data-toggle="collapse" href="faq.html#listing" aria-expanded="false">Properties</a>
							</div>
						...
						<!-- END COLLAPSE MOBILE MENU -->
						<li class="dropdown hidden-md-down">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="faq.html#">Properties</a>
							<div class="dropdown-menu">
								<a class="dropdown-item" href="properties-full-list.html">Full List</a>
								<a class="dropdown-item" href="properties-list-right-sidebar.html">List Right Sidebar </a>
								<a class="dropdown-item" href="properties-full-grid.html">Full Grid</a>
						...
						<li class="hidden-lg-up">
							<div class="po">
								<a data-toggle="collapse" href="faq.html#services" aria-expanded="false">Agents</a>
							</div>
						...
						<!-- END COLLAPSE MOBILE MENU -->
						<li class="dropdown hidden-md-down">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="faq.html#">Agents</a>
							<div class="dropdown-menu">
								<a class="dropdown-item" href="agents-listing-grid.html">Agents Listing Grid</a>
								<a class="dropdown-item" href="agents-listing-row.html">Agents Listing Row</a>
								<a class="dropdown-item" href="agent-details.html">Agent Details</a>
						...
						<li class="hidden-lg-up">
							<div class="po">
								<a data-toggle="collapse" href="faq.html#about" aria-expanded="false">Pages</a>
							</div>
						...
						<!-- END COLLAPSE MOBILE MENU -->
						<li class="dropdown hidden-md-down">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="faq.html#">Pages</a>
							<div class="dropdown-menu">
								<a class="dropdown-item" href="about.html">About Us</a>
								<a class="dropdown-item" href="faq.html">Faq</a>
								<a class="dropdown-item" href="pricing-table.html">Pricing</a>
						...
						<li class="hidden-lg-up">
							<div class="po">
								<a data-toggle="collapse" href="faq.html#blog" aria-expanded="false">Blog</a>
							</div>
						...
						<!-- END COLLAPSE MOBILE MENU -->
						<li class="dropdown hidden-md-down">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="faq.html#">Blog</a>
							<div class="dropdown-menu">
								<a class="dropdown-item" href="blog.html">Blog Default</a>
								<a class="dropdown-item" href="blog-rightsidebar.html">Blog Right Sidebar</a>
								<a class="dropdown-item" href="blog-details.html">Blog Details</a>
 ...
 <a data-toggle="collapse" data-parent="#accordion" href="faq.html#tab-1">What payment methods are available?</a>
                            </h4>
							...
							<div class="panel panel-default">
								<h4 class="panel-heading">
        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="faq.html#tab-2">How can i get realhome aid to live off campus?</a>
                            </h4>
							...
							<div class="panel panel-default">
								<h4 class="panel-heading">
        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="faq.html#tab-3" >Does realhome share my information with others?</a>
                            </h4>
							...
							<div class="panel panel-default">
								<h4 class="panel-heading">
 <a data-toggle="collapse" data-parent="#accordion" href="faq.html#tab-4">What kind of real estate advice do you give?</a>
                            </h4>
							...
							<div class="panel panel-default">
								<h4 class="panel-heading">
        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="faq.html#tab-5" >How do i link multiple accounts with my profile?</a>
                            </h4>
							...
							<div class="panel panel-default">
								<h4 class="panel-heading">
        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="faq.html#tab-6" >What kind of real estate advice do you give?</a>
                            </h4>
							...
							<div class="panel panel-default">
								<h4 class="panel-heading">
 <a data-toggle="collapse" data-parent="#accordion" href="faq.html#tab-7">Is your advice really be helf full?</a>
                            </h4>
							...
							<div class="panel panel-default">
								<h4 class="panel-heading">
        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="faq.html#tab-8" >How can i get real estate aid to live off campus?</a>
                            </h4>
        ...
        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="faq.html#tab-9" >Does realhome share my information with others?</a>
                            </h4>
			...
			<div class="container">
				<div class="row">
							...
							<div class="twitter-widget contuct">
								<div class="twitter-area">
									<div class="single-item">
										...
										<div class="text">
											<h5><a href="faq.html#">@findhouses</a> all share them with me baby said inspet.</h5>
					...
					<div class="col-lg-3 col-md-6">
						...
						<ul class="netsocials">
							<li><a href="faq.html#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
							<li><a href="faq.html#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
							<li><a href="faq.html#"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
							<li><a href="faq.html#"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
						</ul>
					</div>
				</div>
			</div>
	...
	<a data-scroll href="faq.html#heading" class="go-up"><i class="fa fa-angle-double-up" aria-hidden="true"></i></a>
	<!-- END FOOTER -->
	<!--Style Switcher===========================================-->
	<div class="color-switcher" id="choose_color"> <a href="faq.html#." class="picker_close"><i class="fa fa-cog fa-spin fa-2x" ></i></a>
		<div class="theme-colours">
			<p class="font-italic">Choose Colour style</p>
			<ul>
				<li>
					<a href="faq.html#." class="blue" id="blue"></a>
				</li>
				<li>
					<a href="faq.html#." class="pink" id="pink"></a>
				</li>
				<li>
					<a href="faq.html#." class="orange" id="orange"></a>
				</li>
				<li>
					<a href="faq.html#." class="purple" id="purple"></a>
				</li>
				<li>
					<a href="faq.html#." class="green" id="green"></a>
				</li>
				<li>
					<a href="faq.html#." class="red" id="red"></a>
				</li>
				<li>
					<a href="faq.html#." class="cyan" id="cyan"></a>
				</li>
				<li>
					<a href="faq.html#." class="sky-blue" id="sky-blue"></a>
				</li>
				<li>
					<a href="faq.html#." class="gray" id="gray"></a>
				</li>
				<li>
					<a href="faq.html#." class="brown" id="brown"></a>
				</li>
			</ul>
		</div>
	</div>
