    ...
    <div id="rev_slider_home" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
        <ul>
            ...
            <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default"
                ...
                data-thumb="{{asset('guest/images/slider/slider-1.jpg')}}" data-rotate="0" data-fstransition="fade"
                data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Make an Impact">
                <!-- MAIN IMAGE -->
                <img src="{{asset('guest/images/slider/slider-1.jpg')}}" alt="" data-bgposition="center center"
                ...
                <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" id="slide-1-layer-4"
                     ...
                     data-mask_in="x:0px;y:0px;s:inherit;e:inherit;" data-mask_out="x:0;y:0;s:inherit;e:inherit;"
                     data-start="1000" data-splitin="none" data-splitout="none" data-responsive_offset="on"
                     style="z-index: 7; white-space: nowrap;"><a href="index-4.html#"
                                                                 class="btn btn-default btn-theme-colored2 btn-xl"> @lang("Voir Plus")</a>
                    <a href="index-4.html#" class="btn btn-dark btn-theme-colored btn-xl">@lang("Nous contacter")</a>
                </div>
            </li>
            ...
            <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default"
                data-easein="default" data-easeout="default" data-masterspeed="default"
                data-thumb="{{asset('guest/images/slider/slider-2.jpg')}}" data-rotate="0" data-fstransition="fade"
                data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Make an Impact">
                <!-- MAIN IMAGE -->
                <img src="{{asset('guest/images/slider/slider-2.jpg')}}" alt="" data-bgposition="center center"
                     data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg"
                     data-no-retina>
                <!-- LAYERS -->
                <!-- LAYER NR. 1 -->
                ...
                <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" id="slide-2-layer-2"
                     ...
                     data-mask_in="x:0px;y:0px;s:inherit;e:inherit;" data-mask_out="x:0;y:0;s:inherit;e:inherit;"
                     data-start="1000" data-splitin="none" data-splitout="none" data-responsive_offset="on"
                     style="z-index: 7; white-space: nowrap;">@lang("Une solution en Ligne Simple")
                </div>
                <!-- LAYER NR. 3 -->
                <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" id="slide-2-layer-3"
                     ...
                     data-mask_in="x:0px;y:0px;s:inherit;e:inherit;" data-mask_out="x:0;y:0;s:inherit;e:inherit;"
                     data-start="1000" data-splitin="none" data-splitout="none" data-responsive_offset="on"
                     style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal;">@lang("Rentabiliser vos")
                    <span
                        class="text-theme-colored2">  @lang("Biens Immobiliers en tant que Propriétaire")<br></span>
                    <span class="text-theme-colored2"></span>
                </div>
                <!-- LAYER NR. 4 -->
                <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0 font-p" id="slide-2-layer-4"
                     ...
                     data-mask_in="x:0px;y:0px;s:inherit;e:inherit;" data-mask_out="x:0;y:0;s:inherit;e:inherit;"
                     data-start="1000" data-splitin="none" data-splitout="none" data-responsive_offset="on"
                     style="z-index: 7; white-space: nowrap;"> <br> <br><br><Br><br>@lang("Nous fournissons toujours à nos clients un service de qualité")
                ...
                <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" id="slide-2-layer-5"
                     ...
                     data-start="1000" data-splitin="none" data-splitout="none" data-responsive_offset="on"
                     style="z-index: 7; white-space: nowrap;"><a href="index-4.html#"
                                                                 class="btn btn-dark btn-theme-colored btn-xl"> @lang("Voir Plus")</a>
                </div>
            </li>
            ...
            <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default"
                data-easein="default" data-easeout="default" data-masterspeed="default"
                data-thumb="{{asset('guest/images/slider/slider-3.jpg')}}" data-rotate="0" data-fstransition="fade"
                data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Make an Impact">
                <!-- MAIN IMAGE -->
                <img src="{{asset('guest/images/slider/slider-3.jpg')}}" alt="" data-bgposition="top 20%"
                     data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg"
                     data-no-retina>
                <!-- LAYERS -->
                <!-- LAYER NR. 1 -->
                ...
                <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" id="slide-3-layer-4"
                     ...
                     data-mask_in="x:0px;y:0px;s:inherit;e:inherit;" data-mask_out="x:0;y:0;s:inherit;e:inherit;"
                     data-start="1000" data-splitin="none" data-splitout="none" data-responsive_offset="on"
                     style="z-index: 7; white-space: nowrap;"> <br><br><a href="index-4.html#"
                                                                 class="btn btn-dark btn-theme-colored btn-xl"> @lang("Voir Plus")</a>
                </div>
                <!-- LAYER NR. 4 -->
        ...
        <div class="tp-bannertimer tp-bottom" style="height: 5px; background-color: #b2b80b;"></div>
    </div>
</div>
